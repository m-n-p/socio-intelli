...
const Page = () => {
  ...
  return (
    <div className=" min-h-screen bg-white">
      <div className="px-40 py-10 text-5xl font-semibold ">Profile Page</div>

      <div className="px-40 py-10 grid grid-cols-3 gap-10">
        ...
        <div className="bg-slate-200 rounded-full p-6 flex flex-col justify-center space-y-6">
          <div className="text-3xl font-semibold text-center">CreditsUsed</div>
          <div className="text-3xl font-semibold text-purple-500  text-center">
            {threads?.userInfo?.CreditsUsed}
          </div>
        </div>
      </div>
      <div className="px-40 py-10 flex flex-col space-y-10">
              ...
              {threads?.userInfo?.userHistory?.map((his, index) => {
                return (
                  ...
                  >
                    ...
                    <td class="px-6 py-4">{his?.engine}</td>
